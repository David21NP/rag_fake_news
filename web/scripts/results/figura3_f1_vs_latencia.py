...
def main():
    ...
    ax.axhline(
        y=0.9242, color="#2d6a4f", linewidth=1.3, linestyle="--", alpha=0.7,
    )
    ax.text(
        235,
        0.927,
    ...
    ax.axhline(
        y=0.8700, color="#52b788", linewidth=1.3, linestyle="--", alpha=0.7,
    )
    ax.text(
        235,
        0.873,
    ...
    plt.tight_layout()
    plt.savefig(
        RESULTS_PATH / "figura3_f1_vs_latencia.png",
        dpi=300,
        bbox_inches="tight",
    )
    print(f"Guardada: {RESULTS_PATH / "figura3_f1_vs_latencia.png"}")
